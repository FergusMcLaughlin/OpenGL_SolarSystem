...
GLWrapper::GLWrapper(int width, int height, const char* title) {
	...
	glfwSetWindowTitle(window, "Solar_System");
...
void GLWrapper::DisplayVersion()
{
	...
	cout << "          -Controls- " << endl;
	cout << "-Press Space bar to star." << endl;
	cout << "-Press Backspace to stop. " << endl;
	cout << "-Mouse Wheel to zoom in and out." << endl;
	cout << "-Press V to cycle between camera positions." << endl;
	cout << "-A and S cahnge the model size." << endl;
	cout << "-Press D to change the drawtype of the planets." << endl;
	cout << "-Pressing a number from 1 to 9 will direct the camera to that planet and ` will select a spacecraft." << endl;
	cout << "______________________________ " << endl;
...
void GLWrapper::setCursorPosCallback(void(*func)(GLFWwindow* window, double xpos, double ypos)) {
